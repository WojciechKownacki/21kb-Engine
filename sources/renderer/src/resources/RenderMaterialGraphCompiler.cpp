...
void AppendIrPins(RenderMaterialGraphIrNode& irNode) {
    detail::RenderMaterialGraphPinSchema::VisitStaticPins(
        irNode.kind,
        [&irNode](std::string_view name, detail::RenderMaterialGraphPinSchema::Direction direction) {
            AppendIrPin(
                irNode,
                irNode.kind,
                name,
                direction == detail::RenderMaterialGraphPinSchema::Direction::Output);
        });
}
