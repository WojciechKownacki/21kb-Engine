...
class UserWidgetBackgroundBlur {
  public:
    UserWidgetBackgroundBlur() = default;
    ~UserWidgetBackgroundBlur();

    UserWidgetBackgroundBlur(const UserWidgetBackgroundBlur&) = delete;
    UserWidgetBackgroundBlur& operator=(const UserWidgetBackgroundBlur&) = delete;
