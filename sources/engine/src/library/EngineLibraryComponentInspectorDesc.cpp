...
const std::vector<LibraryComponentInspectorDesc>& EngineLibraryComponentInspectorRegistry::Catalog() {
    ...
    static const std::vector<LibraryComponentInspectorDesc> kCatalog = [] {
        ...
        LibraryComponentInspectorDesc{
            .componentName = "Geometry Swarm",
            .displayName = "Geometry Swarm",
            .category = "Rendering",
            .fields = {
                LibraryComponentInspectorFieldDesc{ "meshAssetId", "Mesh Asset", "Mesh instanced by the generated swarm." },
                LibraryComponentInspectorFieldDesc{ "materialAssetId", "Material Asset", "Material used by every generated instance." },
                LibraryComponentInspectorFieldDesc{ "instanceCount", "Instance Count", "Total generated mesh instances." },
                LibraryComponentInspectorFieldDesc{ "columns", "Columns", "Number of instances along the local X axis." },
                LibraryComponentInspectorFieldDesc{ "rows", "Rows", "Number of instances along the local Y axis." },
                LibraryComponentInspectorFieldDesc{ "layers", "Layers", "Number of instances along the local Z axis." },
                LibraryComponentInspectorFieldDesc{ "spacing.x", "Spacing X", "Distance between generated columns." },
                LibraryComponentInspectorFieldDesc{ "spacing.y", "Spacing Y", "Distance between generated rows." },
                LibraryComponentInspectorFieldDesc{ "spacing.z", "Spacing Z", "Distance between generated layers." },
                LibraryComponentInspectorFieldDesc{ "instanceScale", "Instance Scale", "Uniform scale of every generated instance." },
                LibraryComponentInspectorFieldDesc{ "layer", "Layer", "Render layer mask for generated instances." },
                LibraryComponentInspectorFieldDesc{ "castsShadow", "Casts Shadow", "Whether generated instances cast shadows." },
                LibraryComponentInspectorFieldDesc{ "receivesShadow", "Receives Shadow", "Whether generated instances receive shadows." },
                LibraryComponentInspectorFieldDesc{ "enabled", "Enabled", "Whether this swarm contributes generated instances." },
            },
        },
        LibraryComponentInspectorDesc{
            .componentName = "Surface Cast",
            .displayName = "Surface Cast",
            .category = "Rendering",
            .fields = {
                LibraryComponentInspectorFieldDesc{ "materialAssetId", "Material Asset", "Material projected onto matching receiver geometry." },
                LibraryComponentInspectorFieldDesc{ "receiverLayerMask", "Receiver Layer Mask", "Receiver render layers accepted by this cast." },
                LibraryComponentInspectorFieldDesc{ "order", "Order", "Deterministic priority among overlapping casts." },
                LibraryComponentInspectorFieldDesc{ "content", "Content", "Whether the cast affects primary or detail content." },
                LibraryComponentInspectorFieldDesc{ "enabled", "Enabled", "Whether this cast affects matching receivers." },
            },
        },
        LibraryComponentInspectorDesc{
            .componentName = "Facing Panel",
            .displayName = "Facing Panel",
            .category = "Rendering",
            .fields = {
                LibraryComponentInspectorFieldDesc{ "mode", "Mode", "View, point, axis, or fixed orientation policy." },
                LibraryComponentInspectorFieldDesc{ "targetPoint.x", "Target X", "World target point X coordinate." },
                LibraryComponentInspectorFieldDesc{ "targetPoint.y", "Target Y", "World target point Y coordinate." },
                LibraryComponentInspectorFieldDesc{ "targetPoint.z", "Target Z", "World target point Z coordinate." },
                LibraryComponentInspectorFieldDesc{ "axis.x", "Axis X", "World facing-axis X component." },
                LibraryComponentInspectorFieldDesc{ "axis.y", "Axis Y", "World facing-axis Y component." },
                LibraryComponentInspectorFieldDesc{ "axis.z", "Axis Z", "World facing-axis Z component." },
                LibraryComponentInspectorFieldDesc{ "up.x", "Up X", "Reference up-vector X component." },
                LibraryComponentInspectorFieldDesc{ "up.y", "Up Y", "Reference up-vector Y component." },
                LibraryComponentInspectorFieldDesc{ "up.z", "Up Z", "Reference up-vector Z component." },
                LibraryComponentInspectorFieldDesc{ "enabled", "Enabled", "Whether the renderer applies this orientation policy." },
            },
        },
        LibraryComponentInspectorDesc{
            ...
            .fields = {
                ...
                LibraryComponentInspectorFieldDesc{ "materialAssetId", "Material Asset", "Optional material used for generated stroke segments." },
                LibraryComponentInspectorFieldDesc{ "mode", "Mode", "Polyline, spline, beam, or cable generation mode." },
                LibraryComponentInspectorFieldDesc{ "width", "Width", "Cross-section width of generated stroke segments." },
                LibraryComponentInspectorFieldDesc{ "cableSag", "Cable Sag", "Downward cable displacement between endpoints." },
                LibraryComponentInspectorFieldDesc{ "splineSegments", "Spline Segments", "Generated segment count for spline mode." },
                LibraryComponentInspectorFieldDesc{ "layer", "Layer", "Render layer mask for generated segments." },
                LibraryComponentInspectorFieldDesc{ "castsShadow", "Casts Shadow", "Whether generated segments cast shadows." },
                LibraryComponentInspectorFieldDesc{ "receivesShadow", "Receives Shadow", "Whether generated segments receive shadows." },
                LibraryComponentInspectorFieldDesc{ "enabled", "Enabled", "Whether this curve is expanded into renderable segments." },
            },
        },
        LibraryComponentInspectorDesc{
            ...
            .fields = {
                ...
                LibraryComponentInspectorFieldDesc{ "materialAssetId", "Material Asset", "Optional material used for generated ribbon segments." },
                LibraryComponentInspectorFieldDesc{ "lifetimeSeconds", "Lifetime", "How long a sampled position remains in the ribbon." },
                LibraryComponentInspectorFieldDesc{ "width", "Width", "Ribbon width in world units." },
                LibraryComponentInspectorFieldDesc{ "sampleIntervalSeconds", "Sample Interval", "Minimum time between retained samples." },
                LibraryComponentInspectorFieldDesc{ "layer", "Layer", "Render layer mask for generated ribbon segments." },
                LibraryComponentInspectorFieldDesc{ "castsShadow", "Casts Shadow", "Whether generated ribbon segments cast shadows." },
                LibraryComponentInspectorFieldDesc{ "receivesShadow", "Receives Shadow", "Whether generated ribbon segments receive shadows." },
                LibraryComponentInspectorFieldDesc{ "enabled", "Enabled", "Whether this entity records and renders a history ribbon." },
            },
        },
        LibraryComponentInspectorDesc{
        ...
        LibraryComponentInspectorDesc{
            ...
            .fields = {
                ...
                LibraryComponentInspectorFieldDesc{ "profileMaterialAssetId", "Profile Material", "Material profile used by the optical artifact." },
                LibraryComponentInspectorFieldDesc{ "intensity", "Intensity", "Optical echo intensity." },
                LibraryComponentInspectorFieldDesc{ "size", "Size", "Billboard size in world units." },
                LibraryComponentInspectorFieldDesc{ "layer", "Layer", "Render layer mask." },
                LibraryComponentInspectorFieldDesc{ "occlusionRule", "Occlusion Rule", "Depth-tested or always-visible source policy." },
