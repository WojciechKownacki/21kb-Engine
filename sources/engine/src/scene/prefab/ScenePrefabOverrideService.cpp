...
bool ScenePrefabOverrideService::Revert(Scene& scene, std::span<const ScenePrefabInstanceHandle> handles) {
    return ScenePrefabOverrideMutationService::Revert(scene, handles);
}
