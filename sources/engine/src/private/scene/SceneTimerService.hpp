...
public:
    ...
    [[nodiscard]] static std::uint64_t Once(Scene& scene, float delaySeconds, SceneEntity owner) noexcept;
    [[nodiscard]] static std::uint64_t Repeat(Scene& scene, float intervalSeconds, SceneEntity owner) noexcept;
