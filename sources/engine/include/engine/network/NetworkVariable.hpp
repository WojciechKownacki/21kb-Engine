...
public:
    ...
    [[nodiscard]] bool Set(T value) noexcept { if(value_==value)return false; const T previous=value_; value_=value; ++revision_; if(callback_!=nullptr)callback_(context_,previous,value_); return true; }
