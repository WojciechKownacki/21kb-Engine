...
struct InputAssetFormat {
    ...
    // BinaryVersion below with action and mapping-context assets.
    ...
    // snapshots, for deterministic-replay tests. Recording v4 adds the
    // per-frame Unicode text channel and pointer coordinate-space extent; the
    // decoder retains v3 compatibility.
