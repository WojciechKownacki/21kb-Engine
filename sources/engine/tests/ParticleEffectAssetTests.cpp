...
void RunValidatorMatrixTest() {
    ...
    rejects(
        "graph depth",
        [](ParticleEffectAsset& value) {
            value.eventBindings.push_back(ParticleEventBindingAsset{.sourceEmitterId = 11U,
                                                                    .trigger = ParticleEventTrigger::Death,
                                                                    .action = ParticleEventAction::EmitTargetEmitter,
                                                                    .targetEmitterId = 12U,
                                                                    .count = 1U,
                                                                    .maxDepth = 3U,
                                                                    .perStepBudget = 1U});
            value.eventBindings.push_back(ParticleEventBindingAsset{.sourceEmitterId = 12U,
                                                                    .trigger = ParticleEventTrigger::Death,
                                                                    .action = ParticleEventAction::EmitTargetEmitter,
                                                                    .targetEmitterId = 13U,
                                                                    .count = 1U,
                                                                    .maxDepth = 3U,
                                                                    .perStepBudget = 1U});
            value.eventBindings.push_back(ParticleEventBindingAsset{.sourceEmitterId = 13U,
                                                                    .trigger = ParticleEventTrigger::Death,
                                                                    .action = ParticleEventAction::EmitTargetEmitter,
                                                                    .targetEmitterId = 14U,
                                                                    .count = 1U,
