...
void RunComponentInspectorDescCatalogTest() {
    ...
    kb::tests::Require(fieldsChecked == 187U, "Engine21kbLibrary component inspector catalog did not exercise the expected total field count (187) across all components");
