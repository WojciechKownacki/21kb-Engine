...
void RunComponentInspectorDescCatalogTest() {
    ...
    kb::tests::Require(fieldsChecked == 180U, "Engine21kbLibrary component inspector catalog did not exercise the expected total field count (180) across all components");
