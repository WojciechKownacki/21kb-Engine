...
void RunComponentInspectorDescCatalogTest() {
    ...
    kb::tests::Require(fieldsChecked == 498U, "Engine21kbLibrary component inspector catalog did not exercise the expected total field count (498, including the Light compatibility alias) across all components");
