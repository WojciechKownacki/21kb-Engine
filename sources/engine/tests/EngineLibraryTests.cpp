...
void RunGameInstanceLifetimeTest() {
    kb::core::EngineLog engineLog{ 2U }; kb::tests::Require(engineLog.Write({ .level=kb::core::LogLevel::Warn, .category="AI", .message="event", .entity=1U, .world=2U }, 5U, 1U) && !engineLog.Write({}, 5U, 1U) && engineLog.Records().front().entity==1U, "Engine log did not retain context or rate limit duplicate key");
