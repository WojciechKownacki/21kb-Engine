...
void RunVisualGraphWaitContinuationTest() {
    ...
    const kb::visual::VisualGraphNativeCode generated = kb::visual::VisualGraphNativeCodeGenerator::Generate(
        artifact.module,
        kb::visual::VisualGraphNativeCodegenDesc{ .className = "WaitGraph", .namespaceName = "kb::tests" });
    kb::tests::Require(generated.Succeeded(), "Visual graph Wait native code generation failed");
    kb::tests::Require(generated.header.find("Suspend(std::uint32_t eventNodeId") != std::string::npos &&
