...
std::vector<std::string> MaterialEditorState::MaterialDiffRows() const {
...
const std::vector<std::string>& MaterialEditorState::Diagnostics() const {
    EnsureGraphDiagnostics();
    return diagnostics_;
}

const std::vector<std::uint32_t>& MaterialEditorState::DiagnosticNodeIds() const {
    EnsureGraphDiagnostics();
    return diagnosticNodeIds_;
}

bool MaterialEditorState::DiagnosticsHaveError() const {
    EnsureGraphDiagnostics();
    return diagnosticsHaveError_;
}

const std::vector<MaterialEditorGraphDiagnosticMarker>& MaterialEditorState::GraphDiagnosticMarkers() const {
    EnsureGraphDiagnostics();
    return graphDiagnosticMarkers_;
}

kb::render::RenderMaterialGraphRuntimeState MaterialEditorState::GraphRuntimeState() const {
    EnsureGraphDiagnostics();
    return graphRuntimeState_;
}

std::string_view MaterialEditorState::GraphRuntimeStateName() const {
    EnsureGraphDiagnostics();
    return kb::render::RenderMaterialGraphRuntimeStateName(graphRuntimeState_);
}

const MaterialEditorMaterialStatsModel& MaterialEditorState::MaterialStats() const {
    EnsureGraphDiagnostics();
    return materialStats_;
}

const MaterialEditorShaderViewerModel& MaterialEditorState::ShaderViewer() const {
    EnsureGraphDiagnostics();
    return shaderViewer_;
}

const std::vector<MaterialEditorFindResult>& MaterialEditorState::FindResults() const {
    EnsureFindResults();
    return findResults_;
}

void MaterialEditorState::SetFindQuery(std::string query) {
    findQuery_ = std::move(query);
    InvalidateFindResults();
}

void MaterialEditorState::AppendFindText(wchar_t character) {
    if (character < 0x20) {
        return;
    }
...
void MaterialEditorState::InsertFindText(std::string_view text) {
...
void MaterialEditorState::BackspaceFind() {
    if (findQuery_.empty()) {
        return;
    }
    findQuery_.pop_back();
...
void MaterialEditorState::ClearFindQuery() {
    findQuery_.clear();
    findResults_.clear();
    findResultsStale_ = false;
}

std::optional<MaterialEditorFindFocusTarget> MaterialEditorState::FindResultFocusTarget(std::size_t index) const {
    EnsureFindResults();
...
bool MaterialEditorState::FocusFindResult(std::size_t index) {
    EnsureFindResults();
    if (index >= findResults_.size()) {
        return false;
    }
...
const std::vector<MaterialEditorParameter>& MaterialEditorState::Parameters() const {
    EnsureParameters();
    return parameters_;
}

std::vector<MaterialEditorInstanceParentChainRow> MaterialEditorState::InstanceParentChainRows() const {
...
std::vector<MaterialEditorInstanceOverrideGroupRow> MaterialEditorState::InstanceOverrideGroups() const {
...
bool MaterialEditorState::ToggleInstanceOverrideGroup(MaterialEditorParameterGroup group) noexcept {
...
std::vector<MaterialEditorInstanceStaticSwitchRow> MaterialEditorState::InstanceStaticSwitchRows() const {
...
std::vector<MaterialEditorLayerTreeRow> MaterialEditorState::LayerTreeRows() const {
...
bool MaterialEditorState::AddLayerStackEntry(
    std::uint32_t nodeId,
...
bool MaterialEditorState::SetLayerStackEntry(
    std::uint32_t nodeId,
    std::size_t index,
    kb::render::RenderMaterialGraphLayerStackEntry entry
) {
...
bool MaterialEditorState::RemoveLayerStackEntry(std::uint32_t nodeId, std::size_t index) {
    if (!workingCopy_.has_value() || instanceWorkingCopy_.has_value()) {
        return false;
    }
    kb::render::RenderMaterialAssetData document = *workingCopy_;
...
bool MaterialEditorState::ClearInstanceParameterOverride(
...
bool MaterialEditorState::SetInstanceStaticParameterOverride(
    std::string_view stableId,
...
std::uint64_t MaterialEditorState::DocumentRevision() const noexcept {
    return documentRevision_;
}

bool MaterialEditorState::IsGraphConstantInlineEditDirty() const noexcept {
    return inlineConstantEditNodeId_ != 0U && inlineConstantEditBuffer_ != inlineConstantEditOriginal_;
}

std::string MaterialEditorState::GraphNodeDisplayName(std::uint32_t nodeId) const {
...
bool MaterialEditorState::MoveGraphNode(std::uint32_t nodeId, std::int32_t positionX, std::int32_t positionY) {
    if (!workingCopy_.has_value() || nodeId == 0U) {
        return false;
    }
...
bool MaterialEditorState::MoveGraphNodes(
...
bool MaterialEditorState::AlignSelectedGraphNodes(MaterialEditorGraphAlignMode mode) {
...
bool MaterialEditorState::DistributeSelectedGraphNodes(MaterialEditorGraphDistributeAxis axis) {
...
bool MaterialEditorState::CanPromoteSelectedGraphNodeToParameter() const {
...
bool MaterialEditorState::PromoteSelectedGraphNodeToParameter(std::uint32_t* promotedNodeId) {
    if (!workingCopy_.has_value() || selectedNodeId_ == 0U || selectedNodeIds_.size() != 1U) {
        return false;
    }
...
bool MaterialEditorState::SetGraphConstantValue(std::uint32_t nodeId, std::string_view valueText) {
    if (!workingCopy_.has_value() || nodeId == 0U) {
        return false;
    }
...
std::optional<float> MaterialEditorState::GraphConstantComponentValue(
    std::uint32_t nodeId,
...
std::optional<kb::render::RenderMaterialParameterRange> MaterialEditorState::GraphConstantComponentRange(
    std::uint32_t nodeId,
    std::size_t componentIndex
) const {
    if (!workingCopy_.has_value() || nodeId == 0U) {
...
bool MaterialEditorState::SetGraphConstantComponentValue(
    std::uint32_t nodeId,
    std::size_t componentIndex,
...
bool MaterialEditorState::SetGraphConstantColorValue(std::uint32_t nodeId, const std::array<float, 4U>& color) {
    if (!workingCopy_.has_value() || nodeId == 0U ||
...
bool MaterialEditorState::SetGraphNodeColorPropertyValue(
    std::uint32_t nodeId,
...
bool MaterialEditorState::SetGraphNodeEnumValue(
    std::uint32_t nodeId,
    std::string_view propertyId,
...
bool MaterialEditorState::SetGraphNodeTextProperty(
    std::uint32_t nodeId,
    std::string_view propertyId,
    std::string_view value
) {
...
bool MaterialEditorState::SetGraphMaterialFunctionCallSignature(
    std::uint32_t nodeId,
...
std::vector<MaterialEditorGraphNodeProperty> MaterialEditorState::GraphNodeProperties(std::uint32_t nodeId) const {
...
void MaterialEditorState::ToggleGraphNodeEnumDropdown(std::uint32_t nodeId, std::string propertyId) {
...
void MaterialEditorState::CloseGraphNodeEnumDropdown() noexcept {
...
bool MaterialEditorState::IsGraphNodeEnumDropdownOpen(std::uint32_t nodeId, std::string_view propertyId) const noexcept {
    return nodeId != 0U &&
        graphNodeEnumDropdownNodeId_ == nodeId &&
        graphNodeEnumDropdownPropertyId_ == propertyId;
}

bool MaterialEditorState::IsMaterialSettingDropdownOpen(std::string_view propertyId) const noexcept {
    return !propertyId.empty() && materialSettingDropdownPropertyId_ == propertyId;
}

void MaterialEditorState::ToggleMaterialSettingDropdown(std::string propertyId) {
...
std::vector<MaterialEditorGraphNodeProperty> MaterialEditorState::MaterialSettingsProperties() const {
    std::vector<MaterialEditorGraphNodeProperty> properties;
    if (!workingCopy_.has_value()) {
        return properties;
    }
...
bool MaterialEditorState::SetGraphMaterialSetting(std::string_view propertyId, std::string_view value) {
...
bool MaterialEditorState::BeginGraphConstantInlineEdit(std::uint32_t nodeId) {
    if (!workingCopy_.has_value() || nodeId == 0U) {
        return false;
    }
    const kb::render::RenderMaterialGraphNode* node = kb::render::FindRenderMaterialGraphNode(workingCopy_->graph, nodeId);
...
void MaterialEditorState::AppendGraphConstantInlineEditText(wchar_t character) {
...
void MaterialEditorState::BackspaceGraphConstantInlineEdit() {
    if (inlineConstantEditNodeId_ != 0U && !inlineConstantEditBuffer_.empty()) {
        inlineConstantEditBuffer_.pop_back();
    }
}

void MaterialEditorState::CancelGraphConstantInlineEdit() noexcept {
    inlineConstantEditNodeId_ = 0U;
    inlineConstantEditBuffer_.clear();
    inlineConstantEditOriginal_.clear();
}

bool MaterialEditorState::BeginGraphNodeRenameEdit(std::uint32_t nodeId) {
    if (!workingCopy_.has_value() || nodeId == 0U) {
        return false;
    }
    const kb::render::RenderMaterialGraphNode* node = kb::render::FindRenderMaterialGraphNode(workingCopy_->graph, nodeId);
...
void MaterialEditorState::AppendGraphNodeRenameEditText(wchar_t character) {
...
void MaterialEditorState::InsertGraphNodeRenameEditText(std::string_view text) {
    if (renameNodeId_ == 0U) {
        return;
    }
    ReplaceSelectedGraphNodeRenameText();
...
void MaterialEditorState::BackspaceGraphNodeRenameEdit() {
    if (renameNodeId_ == 0U) {
        return;
    }
    if (renameSelectAll_) {
...
void MaterialEditorState::ClearGraphNodeRenameEditText() {
    if (renameNodeId_ != 0U) {
        renameBuffer_.clear();
...
void MaterialEditorState::SelectAllGraphNodeRenameEditText() noexcept {
    if (renameNodeId_ != 0U) {
        renameSelectAll_ = true;
    }
}

void MaterialEditorState::CancelGraphNodeRenameEdit() noexcept {
    renameNodeId_ = 0U;
    renameBuffer_.clear();
    renameSelectAll_ = false;
}

bool MaterialEditorState::RenameGraphNode(std::uint32_t nodeId, std::string_view displayName) {
    if (!workingCopy_.has_value() || nodeId == 0U) {
        return false;
    }
...
bool MaterialEditorState::DeleteGraphNode(std::uint32_t nodeId) {
    if (!workingCopy_.has_value() || nodeId == 0U) {
        return false;
    }
...
bool MaterialEditorState::DeleteSelectedGraphNodes() {
...
bool MaterialEditorState::ConnectGraphPins(
...
bool MaterialEditorState::DisconnectGraphInputPin(std::uint32_t toNodeId, std::string_view toPin) {
...
bool MaterialEditorState::DisconnectGraphOutputPin(std::uint32_t fromNodeId, std::string_view fromPin) {
...
bool MaterialEditorState::DisconnectGraphLink(
    std::uint32_t fromNodeId,
    std::string_view fromPin,
    std::uint32_t toNodeId,
    std::string_view toPin
...
bool MaterialEditorState::DisconnectGraphNodeLinks(std::uint32_t nodeId) {
    if (!workingCopy_.has_value() || nodeId == 0U) {
        return false;
    }
...
std::optional<std::pair<std::int32_t, std::int32_t>> MaterialEditorState::GraphNodePosition(std::uint32_t nodeId) const {
    if (!workingCopy_.has_value()) {
        return std::nullopt;
    }
    const kb::render::RenderMaterialGraphNode* node = kb::render::FindRenderMaterialGraphNode(workingCopy_->graph, nodeId);
...
bool MaterialEditorState::AddGraphComment(
    std::string text,
    std::int32_t positionX,
    std::int32_t positionY,
    std::int32_t width,
...
std::optional<kb::render::RenderMaterialGraphCommentBox> MaterialEditorState::GraphComment(
...
std::optional<std::pair<std::int32_t, std::int32_t>> MaterialEditorState::GraphCommentPosition(
    std::uint32_t commentId
) const {
...
std::vector<std::uint32_t> MaterialEditorState::GraphNodeIdsInsideComment(std::uint32_t commentId) const {
...
bool MaterialEditorState::MoveGraphComment(std::uint32_t commentId, std::int32_t positionX, std::int32_t positionY) {
...
bool MaterialEditorState::MoveGraphCommentGroup(
    std::uint32_t commentId,
    std::int32_t positionX,
    std::int32_t positionY,
...
bool MaterialEditorState::SetGraphCommentText(std::uint32_t commentId, std::string_view text) {
    if (!workingCopy_.has_value() || commentId == 0U) {
        return false;
    }
    kb::render::RenderMaterialAssetData document = *workingCopy_;
...
bool MaterialEditorState::SetGraphCommentColor(std::uint32_t commentId, std::uint32_t color) {
    if (!workingCopy_.has_value() || commentId == 0U) {
        return false;
    }
    kb::render::RenderMaterialAssetData document = *workingCopy_;
...
bool MaterialEditorState::DeleteSelectedGraphComment() {
...
bool MaterialEditorState::AddGraphCompositeSubgraph(
    std::string name,
    std::int32_t positionX,
    std::int32_t positionY,
    std::int32_t width,
    ...
    bool collapsed,
    std::uint32_t color,
    std::uint32_t* createdCompositeId
) {
    if (!workingCopy_.has_value()) {
        return false;
    }
...
bool MaterialEditorState::CreateGraphCompositeFromSelection(
    std::string name,
    std::int32_t positionX,
    std::int32_t positionY,
    std::int32_t width,
...
std::optional<kb::render::RenderMaterialGraphCompositeSubgraph> MaterialEditorState::GraphCompositeSubgraph(
...
bool MaterialEditorState::SetGraphCompositeCollapsed(std::uint32_t compositeId, bool collapsed) {
...
bool MaterialEditorState::ToggleGraphCompositeCollapsed(std::uint32_t compositeId) {
    if (!workingCopy_.has_value() || compositeId == 0U) {
        return false;
    }
    kb::render::RenderMaterialGraphCompositeSubgraph* composite = FindMutableGraphComposite(workingCopy_->graph, compositeId);
...
bool MaterialEditorState::CopySelectedGraphNodes() {
    if (!workingCopy_.has_value() || selectedNodeIds_.empty()) {
        return false;
    }
...
bool MaterialEditorState::PasteGraphClipboard(
    std::int32_t offsetX,
    std::int32_t offsetY,
...
bool MaterialEditorState::DuplicateSelectedGraphNodes(
    std::int32_t offsetX,
    std::int32_t offsetY,
    std::vector<std::uint32_t>* pastedNodeIds
) {
...
void MaterialEditorState::Close() noexcept {
    ++documentRevision_;
    openAssetId_ = {};
    workingCopy_.reset();
...
void MaterialEditorState::RefreshDirty() {
...
void MaterialEditorState::SetWorkingCopy(kb::render::RenderMaterialAssetData document) {
...
void MaterialEditorState::SetInstanceWorkingCopy(
...
void MaterialEditorState::MarkSaved() {
    cleanSnapshot_ = workingCopy_;
    InvalidateCleanCanonical();
    if (instanceWorkingCopy_.has_value()) {
        instanceCleanSnapshot_ = instanceWorkingCopy_;
...
void MaterialEditorState::RevertToCleanSnapshot() {
    ++documentRevision_;
    if (instanceWorkingCopy_.has_value() || instanceCleanSnapshot_.has_value()) {
...
bool MaterialEditorState::SelectNode(std::uint32_t nodeId) {
...
bool MaterialEditorState::AddNodeToSelection(std::uint32_t nodeId) {
...
bool MaterialEditorState::ToggleNodeSelection(std::uint32_t nodeId) {
    if (nodeId == 0U) {
        return false;
    }
...
bool MaterialEditorState::SetNodeSelection(std::vector<std::uint32_t> nodeIds, std::uint32_t primaryNodeId) {
...
bool MaterialEditorState::SelectComment(std::uint32_t commentId) {
...
bool MaterialEditorState::ClearCommentSelection() {
...
bool MaterialEditorState::SelectParameter(InspectorPropertyId property) noexcept {
...
bool MaterialEditorState::ToggleInfoPanel() noexcept {
...
void MaterialEditorState::SetInfoPanelVisible(bool visible) noexcept {
...
void MaterialEditorState::FocusFind(bool focused) noexcept {
...
void MaterialEditorState::SetDiagnostics(std::vector<std::string> diagnostics, bool hasError) {
    EnsureGraphDiagnostics();
    externalDiagnostics_.clear();
...
void MaterialEditorState::ApplyCookResult(
...
void MaterialEditorState::ApplyCookMaterialStats(
...
void MaterialEditorState::ClearDiagnostics() {
    externalDiagnostics_.clear();
    externalDiagnosticsHaveError_ = false;
...
std::optional<kb::render::RenderMaterialGraphNodeKind> MaterialEditorState::PromotedParameterKind(
    kb::render::RenderMaterialGraphNodeKind sourceKind
) noexcept {
    switch (sourceKind) {
...
std::string MaterialEditorState::PromotedSourceOutputPin(kb::render::RenderMaterialGraphNodeKind sourceKind) {
    switch (sourceKind) {
    case kb::render::RenderMaterialGraphNodeKind::ConstantVector2:
        return "xy";
    case kb::render::RenderMaterialGraphNodeKind::ConstantVector:
...
std::string MaterialEditorState::PromotedTargetOutputPin(kb::render::RenderMaterialGraphNodeKind targetKind) {
    switch (targetKind) {
...
std::string MaterialEditorState::PromotedParameterDefaultValueHint(
...
bool MaterialEditorState::SelectGraphLinkedNodes(bool downstream) {
    if (!workingCopy_.has_value() || selectedNodeIds_.empty()) {
        return false;
    }
...
std::string MaterialEditorState::GraphDiagnosticLine(const kb::render::RenderMaterialGraphDiagnostic& diagnostic) {
...
MaterialEditorParameterValue MaterialEditorState::ScalarValue(float value) {
...
MaterialEditorParameterValue MaterialEditorState::Vec3Value(const float value[3], MaterialEditorParameterValueKind kind) {
    return MaterialEditorParameterValue{
        .kind = kind,
...
MaterialEditorParameterValue MaterialEditorState::Vec4Value(const float value[4], MaterialEditorParameterValueKind kind) {
    return MaterialEditorParameterValue{
        .kind = kind,
...
MaterialEditorParameterValue MaterialEditorState::BoolValue(bool value) {
    return MaterialEditorParameterValue{
...
MaterialEditorParameterValue MaterialEditorState::EnumValue(std::string value) {
    return MaterialEditorParameterValue{
...
std::string MaterialEditorState::PrettifyCanonicalName(std::string_view name) {
    std::string label;
...
const std::vector<MaterialEditorGraphNodePropertyOption>& MaterialEditorState::MaterialSettingOptions(
    std::string_view propertyId
) {
...
std::string MaterialEditorState::MaterialSettingDisplayLabel(std::string_view propertyId, const std::string& value) {
    const std::vector<MaterialEditorGraphNodePropertyOption>& options = MaterialSettingOptions(propertyId);
...
MaterialEditorParameterValue MaterialEditorState::TextureAssetValue(std::uint64_t assetId) {
    return MaterialEditorParameterValue{
...
std::string MaterialEditorState::TrimAscii(std::string_view text) {
...
bool MaterialEditorState::ParseDecimalAssetId(std::string_view text, std::uint64_t& output) noexcept {
    if (text.empty()) {
        return false;
    }
...
bool MaterialEditorState::IsStableGraphIdentifier(std::string_view text) noexcept {
...
std::vector<float> MaterialEditorState::ParseDefaultNumbers(std::string_view text) {
...
bool MaterialEditorState::IsGraphConstantNode(kb::render::RenderMaterialGraphNodeKind kind) noexcept {
...
std::string_view MaterialEditorState::ConstantDisplayName(kb::render::RenderMaterialGraphNodeKind kind) noexcept {
    switch (kind) {
    case kb::render::RenderMaterialGraphNodeKind::ConstantScalar:
        return "Scalar";
...
std::size_t MaterialEditorState::ConstantComponentCount(kb::render::RenderMaterialGraphNodeKind kind) noexcept {
    switch (kind) {
    case kb::render::RenderMaterialGraphNodeKind::ConstantScalar:
    case kb::render::RenderMaterialGraphNodeKind::ConstantBool:
        return 1U;
...
std::optional<std::array<float, 4U>> MaterialEditorState::ParseConstantValue(
    kb::render::RenderMaterialGraphNodeKind kind,
...
std::optional<bool> MaterialEditorState::ParseConstantBool(std::string_view text) noexcept {
...
std::string MaterialEditorState::FloatText(float value) {
    std::ostringstream output;
    output << value;
    return output.str();
}

std::span<const GraphHintNumericPropertyDefinition> MaterialEditorState::GraphHintNumericProperties(
    kb::render::RenderMaterialGraphNodeKind kind
) noexcept {
...
std::array<float, 4U> MaterialEditorState::GraphHintNumericValues(const kb::render::RenderMaterialGraphNode& node) {
    std::array<float, 4U> values{};
    const std::span<const GraphHintNumericPropertyDefinition> definitions = GraphHintNumericProperties(node.kind);
...
std::string MaterialEditorState::GraphHintNumericValueHint(
    kb::render::RenderMaterialGraphNodeKind kind,
...
std::string MaterialEditorState::ConstantDefaultValueHint(
    kb::render::RenderMaterialGraphNodeKind kind,
...
std::optional<kb::render::RenderMaterialParameterRange> MaterialEditorState::ConstantRange(
    const kb::render::RenderMaterialGraphNode& node
) noexcept {
    if (!node.parameter.hasRange) {
        return std::nullopt;
...
float MaterialEditorState::ClampConstantComponentValue(
    const kb::render::RenderMaterialGraphNode& node,
    float value
) noexcept {
    const std::optional<kb::render::RenderMaterialParameterRange> range = ConstantRange(node);
...
void MaterialEditorState::ClampConstantValues(
    const kb::render::RenderMaterialGraphNode& node,
    std::array<float, 4U>& values
) noexcept {
    const std::size_t componentCount = ConstantComponentCount(node.kind);
...
std::array<std::string_view, 4U> MaterialEditorState::ConstantComponentLabels(
    kb::render::RenderMaterialGraphNodeKind kind
) noexcept {
    switch (kind) {
    case kb::render::RenderMaterialGraphNodeKind::ConstantScalar:
...
std::string_view MaterialEditorState::GraphNodeDisplayName(kb::render::RenderMaterialGraphNodeKind kind) noexcept {
    switch (kind) {
...
std::string MaterialEditorState::GraphNodeDisplayNameForNode(const kb::render::RenderMaterialGraphNode& node) {
    if (!node.parameter.displayName.empty()) {
...
std::string MaterialEditorState::NormalizeGraphNodeDisplayName(
...
std::vector<MaterialEditorGraphNodePropertyOption> MaterialEditorState::GraphNodeEnumOptions(
    kb::render::RenderMaterialGraphNodeKind kind,
    std::string_view propertyId
) {
...
std::string MaterialEditorState::GraphNodeUvSetValue(const kb::render::RenderMaterialGraphNode& node) {
    if (node.kind == kb::render::RenderMaterialGraphNodeKind::TextureCoordinate) {
...
bool MaterialEditorState::IsStaticComponentMaskPropertyId(std::string_view propertyId) noexcept {
...
char MaterialEditorState::StaticComponentMaskPropertyChannel(std::string_view propertyId) noexcept {
...
bool MaterialEditorState::StaticComponentMaskChannelEnabled(
    const kb::render::RenderMaterialGraphNode& node,
    std::string_view propertyId
) noexcept {
...
std::string MaterialEditorState::StaticComponentMaskHintWithChannel(
    const kb::render::RenderMaterialGraphNode& node,
    std::string_view propertyId,
    bool enabled
) {
...
bool MaterialEditorState::IsTransformSpaceNode(kb::render::RenderMaterialGraphNodeKind kind) noexcept {
    return kind == kb::render::RenderMaterialGraphNodeKind::Transform ||
        kind == kb::render::RenderMaterialGraphNodeKind::TransformPosition;
}

std::array<std::string, 2U> MaterialEditorState::TransformSpaces(const kb::render::RenderMaterialGraphNode& node) {
...
bool MaterialEditorState::IsTransformSpaceValue(std::string_view value) noexcept {
    return value == "tangent" || value == "Tangent" ||
        value == "world" || value == "World" ||
        value == "view" || value == "View";
}

std::string MaterialEditorState::NormalizeTransformSpaceValue(std::string_view value) {
...
std::string MaterialEditorState::TransformSpaceHintWithProperty(
    const kb::render::RenderMaterialGraphNode& node,
    std::string_view propertyId,
    std::string_view value
) {
...
std::string MaterialEditorState::TextureCoordinateHintWithUvSet(
    const kb::render::RenderMaterialGraphNode& node,
...
std::array<float, 2U> MaterialEditorState::TextureCoordinateTiling(const kb::render::RenderMaterialGraphNode& node) {
...
std::string MaterialEditorState::GraphNodeViewPropertyValue(const kb::render::RenderMaterialGraphNode& node) {
...
std::string MaterialEditorState::GraphNodeSceneTextureSourceValue(const kb::render::RenderMaterialGraphNode& node) {
...
bool MaterialEditorState::IsCustomCodeEditableValueType(kb::render::RenderMaterialGraphPinType type) noexcept {
...
std::vector<MaterialEditorState::ColorRampStop> MaterialEditorState::ColorRampStops(
    const kb::render::RenderMaterialGraphNode& node
) {
...
std::string MaterialEditorState::ColorRampHint(const std::vector<ColorRampStop>& stops) {
    std::string hint;
...
std::optional<std::size_t> MaterialEditorState::ColorRampStopIndexForPositionComponent(
    std::size_t componentIndex
) noexcept {
...
std::optional<std::size_t> MaterialEditorState::ColorRampStopIndexForColorProperty(std::string_view propertyId) noexcept {
...
bool MaterialEditorState::IsGraphTextureAssetNode(kb::render::RenderMaterialGraphNodeKind kind) noexcept {
...
std::uint64_t MaterialEditorState::GraphNodeTextureAssetId(
    const kb::render::RenderMaterialGraphNode& node,
...
MaterialEditorParameterValue MaterialEditorState::DefaultValueForSchema(
...
MaterialEditorParameterValue MaterialEditorState::GraphParameterValueForSchema(
    const kb::render::RenderMaterialParameterSchema& parameter,
    const kb::render::RenderMaterialAssetData& document
) {
    for (const kb::render::RenderMaterialGraphParameterValue& value : document.graphParameterValues) {
...
std::string MaterialEditorState::AlphaModeName(kb::render::RenderMaterialAlphaMode mode) {
    switch (mode) {
...
std::string MaterialEditorState::DecalBlendModeName(kb::render::RenderMaterialDecalBlendMode mode) {
    switch (mode) {
...
std::string MaterialEditorState::LayerBlendModeName(kb::render::RenderMaterialLayerBlendMode mode) {
    switch (mode) {
...
MaterialEditorParameterGroup MaterialEditorState::EditorGroupFor(
    kb::render::RenderMaterialParameterGroup group
) noexcept {
    switch (group) {
...
bool MaterialEditorState::IsStaticOverrideNodeKind(kb::render::RenderMaterialGraphNodeKind kind) noexcept {
...
std::string MaterialEditorState::StableIdForGraphNode(const kb::render::RenderMaterialGraphNode& node) {
...
std::string MaterialEditorState::DefaultStaticOverrideValue(kb::render::RenderMaterialGraphNodeKind kind) {
    switch (kind) {
...
bool MaterialEditorState::IsStaticMaskText(std::string_view text) noexcept {
...
bool MaterialEditorState::IsStaticOverrideValueValid(
    kb::render::RenderMaterialGraphNodeKind kind,
    std::string_view value
) noexcept {
    switch (kind) {
...
const kb::render::RenderMaterialGraphNode* MaterialEditorState::FindStaticOverrideNode(
...
bool MaterialEditorState::RemoveGraphParameterOverride(
...
void MaterialEditorState::RemoveStaticOverride(
...
MaterialEditorParameterValue MaterialEditorState::ParameterValueForField(
...
MaterialEditorParameterValue MaterialEditorState::ParameterValueForSchema(
    const kb::render::RenderMaterialParameterSchema& parameter,
    const kb::render::RenderMaterialAssetData& document,
    const kb::render::RenderMaterialAssetData& fallbackDefaults
) {
...
MaterialEditorParameterValue MaterialEditorState::TextureValueForField(
    std::string_view field,
    const kb::render::RenderMaterialAssetData& document
) {
    for (const kb::render::RenderMaterialGraphParameterValue& value : document.graphParameterValues) {
...
std::vector<MaterialEditorParameter> MaterialEditorState::BuildParameters(
    const kb::render::RenderMaterialAssetData& document,
...
bool MaterialEditorState::InstanceHasGraphParameterOverride(
...
std::vector<MaterialEditorParameter> MaterialEditorState::BuildInstanceParameters(
...
void MaterialEditorState::EnsureEditableGraph(kb::render::RenderMaterialGraphDocument& graph) {
    if (graph.nodes.empty()) {
        graph = kb::render::MakeDefaultRenderMaterialGraphDocument();
    }
}

std::uint32_t MaterialEditorState::NextGraphNodeId(const kb::render::RenderMaterialGraphDocument& graph) noexcept {
...
kb::render::RenderMaterialGraphNode* MaterialEditorState::FindMutableGraphNode(
...
std::uint32_t MaterialEditorState::NextGraphCommentId(const kb::render::RenderMaterialGraphDocument& graph) noexcept {
    std::uint32_t next = 1U;
...
const kb::render::RenderMaterialGraphCommentBox* MaterialEditorState::FindGraphComment(
...
kb::render::RenderMaterialGraphCommentBox* MaterialEditorState::FindMutableGraphComment(
    kb::render::RenderMaterialGraphDocument& graph,
    std::uint32_t commentId
) noexcept {
...
std::uint32_t MaterialEditorState::NextGraphCompositeId(const kb::render::RenderMaterialGraphDocument& graph) noexcept {
    std::uint32_t next = 1U;
...
const kb::render::RenderMaterialGraphCompositeSubgraph* MaterialEditorState::FindGraphComposite(
    const kb::render::RenderMaterialGraphDocument& graph,
    std::uint32_t compositeId
) noexcept {
    for (const kb::render::RenderMaterialGraphCompositeSubgraph& composite : graph.composites) {
...
kb::render::RenderMaterialGraphCompositeSubgraph* MaterialEditorState::FindMutableGraphComposite(
    kb::render::RenderMaterialGraphDocument& graph,
    std::uint32_t compositeId
) noexcept {
...
void MaterialEditorState::RemoveGraphCompositeNodeReferences(
    kb::render::RenderMaterialGraphDocument& graph,
...
bool MaterialEditorState::GraphNodeInsideComment(
    const kb::render::RenderMaterialGraphNode& node,
    const kb::render::RenderMaterialGraphCommentBox& comment
) noexcept {
...
std::optional<MaterialEditorState::GraphClipboard> MaterialEditorState::BuildGraphClipboard(
    const kb::render::RenderMaterialAssetData& document,
...
std::uint32_t MaterialEditorState::RemapGraphNodeId(
...
void MaterialEditorState::PruneSelectionToWorkingCopy() {
    if (!workingCopy_.has_value()) {
        selectedNodeIds_.clear();
        selectedNodeId_ = 0U;
        selectedCommentId_ = 0U;
...
void MaterialEditorState::ReplaceSelectedGraphNodeRenameText() {
    if (renameSelectAll_) {
        renameBuffer_.clear();
        renameSelectAll_ = false;
    }
...
kb::render::RenderMaterialGraphCustomCode MaterialEditorState::DefaultCustomCode() {
...
kb::render::RenderMaterialGraphCustomCode MaterialEditorState::DefaultMaterialFunctionCall() {
    return kb::render::RenderMaterialGraphCustomCode{
        .body = {},
        .outputType = kb::render::RenderMaterialGraphPinType::Float4,
        .inputs = {
...
kb::render::RenderMaterialGraphParameterMetadata MaterialEditorState::DefaultParameterMetadata(
    kb::render::RenderMaterialGraphNodeKind kind,
    std::uint32_t nodeId
) {
    switch (kind) {
...
std::string MaterialEditorState::TextureDimensionName(kb::render::RenderMaterialGraphTextureDimension dimension) {
    switch (dimension) {
...
std::string MaterialEditorState::TextureColorSpaceName(kb::render::RenderMaterialTextureColorSpace colorSpace) {
    switch (colorSpace) {
...
std::string MaterialEditorState::SamplerFilterName(kb::render::RenderMaterialGraphSamplerFilter filter) {
    switch (filter) {
...
std::string MaterialEditorState::SamplerWrapName(kb::render::RenderMaterialGraphSamplerWrap wrap) {
    switch (wrap) {
...
std::string MaterialEditorState::SamplerStateSummary(const kb::render::RenderMaterialGraphSamplerState& state) {
...
MaterialEditorShaderViewerModel MaterialEditorState::ShaderViewerCompileFailure(
...
MaterialEditorShaderViewerModel MaterialEditorState::BuildShaderViewer(
    const kb::render::RenderMaterialGraphCompileResult& compile
) {
    if (!compile.Succeeded()) {
...
char MaterialEditorState::LowerAscii(char ch) noexcept {
    if (ch >= 'A' && ch <= 'Z') {
...
bool MaterialEditorState::ContainsCaseInsensitive(std::string_view text, std::string_view query) noexcept {
    if (query.empty()) {
        return true;
    }
...
bool MaterialEditorState::AnyFindFieldMatches(
...
std::string MaterialEditorState::NodeFindLabel(const kb::render::RenderMaterialGraphNode& node) {
    const std::string stableId = StableIdForGraphNode(node);
    return DisplayNameOrStableId(node.parameter.displayName, stableId);
}

void MaterialEditorState::RefreshFindResults() {
    findResults_.clear();
...
void MaterialEditorState::ClearDerivedGraphDiagnostics() {
    graphDiagnosticsLines_.clear();
...
void MaterialEditorState::InvalidateGraphDiagnostics() {
...
void MaterialEditorState::EnsureGraphDiagnostics() const {
...
void MaterialEditorState::RefreshGraphDiagnostics() {
    graphDiagnosticsStale_ = false;
    ClearDerivedGraphDiagnostics();
    if (!workingCopy_.has_value()) {
        graphRuntimeState_ = kb::render::RenderMaterialGraphRuntimeState::Dirty;
...
void MaterialEditorState::ResetCookDiagnostics() {
    cookDiagnostics_.clear();
...
void MaterialEditorState::RefreshGraphRuntimeState() {
    if (!workingCopy_.has_value()) {
        graphRuntimeState_ = kb::render::RenderMaterialGraphRuntimeState::Dirty;
        return;
    }
...
void MaterialEditorState::RebuildMergedDiagnostics() {
    diagnostics_.clear();
...
void MaterialEditorState::InvalidateParameters() noexcept { parametersStale_ = true; }

void MaterialEditorState::EnsureParameters() const {
    if (!parametersStale_) {
        return;
    }
...
void MaterialEditorState::EnsureFindResults() const {
...
void MaterialEditorState::RefreshParameters() {
    parameters_.clear();
    if (!workingCopy_.has_value()) {
        return;
    }
...
void MaterialEditorState::InvalidateCleanCanonical() noexcept {
    cleanCanonicalValid_ = false;
    cleanCanonical_.clear();
}

const std::string& MaterialEditorState::CleanCanonical() const {
...
bool MaterialEditorState::WorkingCopyMatchesCleanSnapshot() const {
...
std::string MaterialEditorState::CanonicalDocument(const kb::render::RenderMaterialAssetData& document) {
    std::ostringstream output;
    kb::render::RenderMaterialAssetWriter::Write(output, document);
    return output.str();
}

bool MaterialEditorState::EquivalentDocument(
...
std::string MaterialEditorState::CanonicalInstance(const kb::render::RenderMaterialInstanceAssetData& document) {
    std::ostringstream output;
    kb::render::RenderMaterialInstanceAssetWriter::Write(output, document);
    return output.str();
}

bool MaterialEditorState::EquivalentInstance(
